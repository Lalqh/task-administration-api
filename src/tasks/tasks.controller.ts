...
import { ApiAuthHeader, ApiIdParam, ApiNotFound, ApiValidationError } from 'src/common/decorators/swagger.decorators';
...
export class TasksController {
  ...
  @ApiValidationError()
  @ApiNotFound('Task not found')
  update(@Param('id', ParseIntPipe) id: number, @Body() dto: UpdateTaskDto, @UserId() userId: number) {
